...
// // PDF path (adjust if you move PDF to public folder for downloads)
// import pdfFile from "@/assets/CallNexus (1).pdf";
...
//                 className="border-2 border-primary text-primary hover:bg-primary hover:text-primary-foreground text-lg px-8 py-6 rounded-full transition-all"
//               >
//                 <a href={pdfFile} download="CallNexus_Profile.pdf">
  ...
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-30 pointer-events-none">
        <div className="absolute top-10 right-4 sm:top-20 sm:right-20 w-36 h-36 sm:w-72 sm:h-72 bg-primary/20 rounded-full blur-2xl sm:blur-3xl animate-float" />
        <div className="absolute bottom-10 left-4 sm:bottom-20 sm:left-20 w-48 h-48 sm:w-96 sm:h-96 bg-accent/20 rounded-full blur-2xl sm:blur-3xl animate-float" style={{ animationDelay: "1s" }} />
      </div>

      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          {/* Left Content */}
          <div className="text-left space-y-6 sm:space-y-8 animate-fade-in pt-8 sm:pt-0">
            <div className="inline-flex items-center gap-2 px-4 py-3 bg-primary/10 rounded-full text-primary text-sm font-medium" />
            
            <h1 className="text-3xl sm:text-5xl lg:text-6xl xl:text-7xl font-heading font-bold leading-tight">
              Your Bridge to{" "}
              <span className="gradient-text">Exceptional Customer Support</span>
            </h1>
            
            <p className="text-base sm:text-lg lg:text-xl text-muted-foreground max-w-xl sm:max-w-2xl leading-relaxed">
              Delivering 24/7 customer engagement, technical support, and virtual assistance powered by human expertise and AI intelligence.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-2 sm:pt-4">
              <Button 
                asChild
                size="lg" 
                className="bg-gradient-to-r from-primary to-accent hover:opacity-90 transition-opacity text-base sm:text-lg px-6 sm:px-8 py-4 sm:py-6 rounded-full shadow-lg hover:shadow-xl"
              >
                <Link to="/contact">
                  Get a Free Consultation
                  <ArrowRight className="ml-2 h-5 w-5" />
              ...
              <Button 
                ...
                size="lg" 
                variant="outline" 
                className="border-2 border-primary text-primary hover:bg-primary hover:text-primary-foreground text-base sm:text-lg px-6 sm:px-8 py-4 sm:py-6 rounded-full transition-all"
              >
                <a href={pdfFile} download="CallNexus_Profile.pdf">
                  <Download className="mr-2 h-5 w-5" />
                  Download Profile
            ...
            {/* Trust Indicators */}
            <div className="flex flex-col sm:flex-row flex-wrap items-center gap-6 sm:gap-8 pt-6 sm:pt-8 border-t border-border">
              <div className="text-center sm:text-left">
              ...
              <div className="text-center sm:text-left">
                ...
                <div className="text-xs sm:text-sm text-muted-foreground">Support Coverage</div>
              </div>
              <div className="text-center sm:text-left">
          ...
          {/* Right Image */}
          <div className="relative animate-slide-in-right pt-8 lg:pt-0">
            <div className="relative rounded-2xl sm:rounded-3xl overflow-hidden shadow-xl sm:shadow-2xl hover-lift">
              <img 
                src={heroImage} 
                alt="Customer support team working with advanced technology"
            ...
            {/* Floating Elements */}
            <div className="absolute -top-4 sm:-top-6 -right-4 sm:-right-6 bg-white rounded-xl sm:rounded-2xl shadow-lg sm:shadow-xl p-2 sm:p-4 animate-float">
              <MessageCircle className="h-6 w-6 sm:h-8 sm:w-8 text-primary" />
            </div>
            <div className="absolute -bottom-4 sm:-bottom-6 -left-4 sm:-left-6 bg-white rounded-xl sm:rounded-2xl shadow-lg sm:shadow-xl p-4 sm:p-6 animate-float" style={{ animationDelay: "0.5s" }}>
              <div className="text-lg sm:text-2xl font-bold gradient-text">99.9%</div>
              <div className="text-xs text-muted-foreground">Uptime</div>
            </div>
          </div>
        </div>
